...
people.each { |name, info| puts name }

# * What are the names of all the people?
people.each { |name, info | puts "#{ name } #{ info["children"] }"}

# * What is the phone number of Alia O'Conner PhD?
puts people.fetch("Alia O'Conner PhD")["phone"]

# * How many children does Brian Heller have?
puts people.fetch("Brian Heller")["children"].size

# # * What company does Dr. Adela DuBuque work for?
puts people.fetch( "Dr. Adela DuBuque" )[ "company" ]
...
puts people.fetch( "Brian Heller" )[ "children" ]

# * What is Maryse Johns' first child's name?
puts people.fetch( "Maryse Johns" )[ "children" ].first
...
puts sets_of_people.first.size

# * How many people are in the second set of people?
puts sets_of_people[-1].length

# * What is Ruby Hessel's phone number?
puts sets_of_people.first.fetch("Ruby Hessel")["phone"]

# * What are the names of Dr. Sigrid Nader's children?
puts sets_of_people.last.fetch("Dr. Sigrid Nader")["children"]

# * What is Bernard Feil's child's name?
puts sets_of_people.first.fetch("Bernard Feil")["children"]

# * What company does Casandra Kemmer work for?
puts sets_of_people.first.fetch("Casandra Kemmer")["company"]
